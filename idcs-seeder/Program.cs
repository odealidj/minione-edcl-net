...
class Program
{
    ...
    private static async Task ResetDataAsync()
    {
        ...
        // ── Publish SimulationResetIntegrationEvent ──────────────────────────────
        Console.WriteLine("[RabbitMQ] Publishing SimulationResetIntegrationEvent...");
        ...
        try
        {
            await busControl.Publish(new EDCL.Shared.Kernel.Events.SimulationResetIntegrationEvent());
            Console.WriteLine("[RabbitMQ] Event SimulationResetIntegrationEvent published.");
        }
        finally
        {
